{
    "common": [
        ...
        "stripaudio = zcmds.cmds.common.stripaudio:main",
        ...
        "viddur = zcmds.cmds.common.viddur:main",
    ...
    "win32": [
        ...
        "cp = zcmds.cmds.win32.cp:main",
        "du = zcmds.cmds.win32.du:main",
        "grep = zcmds.cmds.win32.grep:main",
        "home = zcmds.cmds.win32.home:main",
        "ls = zcmds.cmds.win32.ls:main",
